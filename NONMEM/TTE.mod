...
$DATA ... IGNORE=@
  ...
  FILE=sdtabtt1 NOPRINT ONEHEADER FORMAT=tF13.4
  $TABLE ID ETAS(1:LAST) ; individual parameters
  FILE=patabtt1 NOPRINT ONEHEADER FORMAT=tF13.4
  $TABLE ID ; continuous covariates
  FILE=cotabtt1 NOPRINT ONEHEADER FORMAT=tF13.4
  $TABLE ID ; categorical covariates
  FILE=catabtt1 NOPRINT ONEHEADER FORMAT=tF13.4
